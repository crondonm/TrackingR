...
for days_infectious in days_infectious_list:
  ...
  df = pd.read_csv('{}/dataset_KL.csv'.format(input_folder))
  ...
  df.to_csv('{}/estimated_R_KL_{}.csv'.format(output_folder, days_infectious), index = False)
...
res = []
for days_infectious in days_infectious_list:
    df_temp = pd.read_csv('{}/estimated_R_KL_{}.csv'.format(output_folder, days_infectious))
    res.append(df_temp)
...
df.to_csv('{}/estimated_R_KL.csv'.format(output_folder), index = False)  