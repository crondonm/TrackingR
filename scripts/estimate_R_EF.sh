...
cd ../code/python
cd ./estimate_R
cp ../../../fixed_revisions/derived_data/dataset/dataset_EF.csv           ./input/estimate_R_STAN/
...
cd ..
python3 -W ignore -m estimate_R.estimate_R_STAN_EF
cp ./estimate_R/output/estimate_R_STAN/estimated_R_EF.csv ../../fixed_revisions/derived_data/R_estimates/
