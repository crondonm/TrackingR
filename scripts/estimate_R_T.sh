...
cd ../code/python
cd ./estimate_R
cp ../../../fixed_revisions/derived_data/dataset/dataset_T.csv           ./input/estimate_R_STAN/
...
cd ..
python3 -W ignore -m estimate_R.estimate_R_STAN_T
cp ./estimate_R/output/estimate_R_STAN/estimated_R_T.csv ../../fixed_revisions/derived_data/R_estimates/
